...
class PrefixTree:
    ...
    def insert(self, string):
        ...
        for ch in string:
            ...
            else:  # insert a char into the tree
    ...
    def complete(self, prefix):
        ...
        # Check if the prefix is a valid prefix of a string in the tree
        if node is None:
            return completions
        # Check if the prefix is a complete word in the tree
        if node.is_terminal():
    ...
    def strings(self):
        ...
        for child in node.children:
            self._traverse(node.get_child(child), child, all_strings.append)
        return all_strings
